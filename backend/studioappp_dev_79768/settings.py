"""
Django settings for studioappp_dev_79768 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "data", "ksdfsdkgfhdsk"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'studioappp_dev_79768.urls'
...
WSGI_APPLICATION = 'studioappp_dev_79768.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studioappp_dev_79768 API",
    "DESCRIPTION": "API documentation for studioappp_dev_79768 App",
    "VERSION": "v1",
}
