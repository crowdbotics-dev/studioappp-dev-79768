...
export const api_v1_storyboard_list = createAsyncThunk("storyboards/api_v1_storyboard_list", async payload => {
  const response = await apiService.api_v1_storyboard_list(payload);
  return response.data;
});
export const api_v1_storyboard_create = createAsyncThunk("storyboards/api_v1_storyboard_create", async payload => {
  const response = await apiService.api_v1_storyboard_create(payload);
  return response.data;
});
export const api_v1_storyboard_retrieve = createAsyncThunk("storyboards/api_v1_storyboard_retrieve", async payload => {
  const response = await apiService.api_v1_storyboard_retrieve(payload);
  return response.data;
});
export const api_v1_storyboard_update = createAsyncThunk("storyboards/api_v1_storyboard_update", async payload => {
  const response = await apiService.api_v1_storyboard_update(payload);
  return response.data;
});
export const api_v1_storyboard_partial_update = createAsyncThunk("storyboards/api_v1_storyboard_partial_update", async payload => {
  const response = await apiService.api_v1_storyboard_partial_update(payload);
  return response.data;
});
export const api_v1_storyboard_destroy = createAsyncThunk("storyboards/api_v1_storyboard_destroy", async payload => {
